            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold">Edit Invoice</h5>
                    ...
                    <form action="{{ route('invoices.update', $invoice) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="subtotal" 
                                        ...
                                        value="{{ old('subtotal', $invoice->subtotal) }}" required id="subtotal">
                                </div>
                                @error('subtotal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="tax_amount" 
                                        ...
                                        value="{{ old('tax_amount', $invoice->tax_amount) }}" id="tax_amount">
                                </div>
                                @error('tax_amount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="discount_amount" 
                                        ...
                                        value="{{ old('discount_amount', $invoice->discount_amount) }}" id="discount_amount">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="total_amount" 
                                        ...
                                        value="{{ old('total_amount', $invoice->total_amount) }}" required id="total_amount" readonly>
                                </div>
                                @error('total_amount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12">
                                ...
                                <textarea name="notes" rows="3" class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $invoice->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12">
                                ...
                                <textarea name="terms" rows="2" class="form-control @error('terms') is-invalid @enderror">{{ old('terms', $invoice->terms) }}</textarea>
                                @error('terms')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
